const calories = document.querySelector(".bmr-calculator1 .result .calories");
const calculateBtn = document.querySelector(
  ".bmr-calculator1 .result .calculate-btn"
);
const age = document.querySelector(".bmr-calculator1 form #age");
const height = document.querySelector(".bmr-calculator1 form #height");
const weight = document.querySelector(".bmr-calculator1 form #weight");
const errorMessage = document.querySelector(
  ".bmr-calculator1 .result .error-message"
);
...
calculateBtn.addEventListener("click", () => {
  ...
  let genderValue = document.querySelector(
    ".bmr-calculator1 form input[name='gender']:checked"
  ).value;
